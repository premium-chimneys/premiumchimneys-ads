...
const GALLERIES = {
  ...
  'chimney-repair': [
    ...
    { img: P.peelingChase,       scope: 'Exterior · Siding',         title: 'Completely weathered chimney',           result: 'Complete rebuild',          alt: 'Weathered chimney chase before and after being re-sided' },
