...
const GALLERIES = {
  ...
  'chimney-repair': [
    ...
    { img: P.brownCapRedBrick,   scope: 'Exterior · Brick stack',    title: 'Brick stack re-crowned and capped',      result: 'Water kept out',            alt: 'Custom brown hip cap with mesh screen on a red brick chimney' },
