  ...
  return (
    <>
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .sv1-card-icon svg{position:relative;z-index:1;filter:drop-shadow(0 1px 2px rgba(45,15,80,.35));transform-origin:center}
      ...
      <section className="sv1">
        <div className="sv1-inner">
          ...
          <div className="sv1-grid">
            <a href={`/chimney-inspection/${city.slug}`} className="sv1-card"><div className="sv1-card-img-wrap"><img className="sv1-card-img" src="https://cdn.prod.website-files.com/6583a3bd0693f08aab1194fe/694441da86840f464e36c79b_chimney-inspection-roofline-flue-evaluation.webp" alt="Chimney Inspection" /></div><div className="sv1-card-body"><div className="sv1-card-header"><div className="sv1-card-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="7" /><line x1="21" y1="21" x2="16.65" y2="16.65" /></svg></div><h3 className="sv1-card-title">Chimney Inspection</h3></div><p className="sv1-card-desc">We check that your chimney is safe, efficient, and up to code.</p><span className="sv1-card-link">Learn More <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M5 12h14M13 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg></span></div></a>
            <a href={`/chimney-sweep/${city.slug}`} className="sv1-card"><div className="sv1-card-img-wrap"><img className="sv1-card-img" src="https://cdn.prod.website-files.com/6583a3bd0693f08aab1194fe/694441dad118f5b09b76612a_chimney-sweep-roof-brush-flue-cleaning.webp" alt="Chimney Sweep" /></div><div className="sv1-card-body"><div className="sv1-card-header"><div className="sv1-card-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M9.06 11.9l8.07-8.06a2.85 2.85 0 1 1 4.03 4.03l-8.06 8.08" /><path d="M7.07 14.94c-1.66 0-3 1.35-3 3.02 0 1.33-2.5 1.52-2 2.02 1.08 1.1 2.49 2.02 4 2.02 2.21 0 4-1.8 4-4.04a3.01 3.01 0 0 0-3-3.02z" /></svg></div><h3 className="sv1-card-title">Chimney Sweep</h3></div><p className="sv1-card-desc">We clean your chimney by removing soot and buildup safely.</p><span className="sv1-card-link">Learn More <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M5 12h14M13 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg></span></div></a>
            <a href={`/chimney-repair/${city.slug}`} className="sv1-card"><div className="sv1-card-img-wrap"><img className="sv1-card-img" src="https://cdn.prod.website-files.com/6583a3bd0693f08aab1194fe/694441da1f125b0cd8259ddc_chimney-repair-flashing-masonry-restoration.webp" alt="Chimney Repair" /></div><div className="sv1-card-body"><div className="sv1-card-header"><div className="sv1-card-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" /></svg></div><h3 className="sv1-card-title">Chimney Repair</h3></div><p className="sv1-card-desc">We bring your chimney back to strong, reliable condition.</p><span className="sv1-card-link">Learn More <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M5 12h14M13 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg></span></div></a>
            <a href={`/chimney-caps/${city.slug}`} className="sv1-card"><div className="sv1-card-img-wrap"><img className="sv1-card-img" src="https://cdn.prod.website-files.com/6583a3bd0693f08aab1194fe/6944464c3d3dac45d014f642_chimney-cap-installation-metal-roof.webp" alt="Chimney Caps" /></div><div className="sv1-card-body"><div className="sv1-card-header"><div className="sv1-card-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /></svg></div><h3 className="sv1-card-title">Chimney Caps</h3></div><p className="sv1-card-desc">We protect your chimney from debris, animals, and moisture.</p><span className="sv1-card-link">Learn More <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M5 12h14M13 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg></span></div></a>
            <a href={`/fireplace-inspection/${city.slug}`} className="sv1-card"><div className="sv1-card-img-wrap"><img className="sv1-card-img" src="https://cdn.prod.website-files.com/6583a3bd0693f08aab1194fe/694441da89a8a6b303d8e2cd_fireplace-inspection-wood-stove-firebox-check.webp" alt="Fireplace Inspection" /></div><div className="sv1-card-body"><div className="sv1-card-header"><div className="sv1-card-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="7" /><line x1="21" y1="21" x2="16.65" y2="16.65" /><line x1="8" y1="11" x2="14" y2="11" /></svg></div><h3 className="sv1-card-title">Fireplace Inspection</h3></div><p className="sv1-card-desc">We check that your fireplace is functioning safely.</p><span className="sv1-card-link">Learn More <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M5 12h14M13 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg></span></div></a>
            <a href={`/fireplace-cleaning/${city.slug}`} className="sv1-card"><div className="sv1-card-img-wrap"><img className="sv1-card-img" src="https://cdn.prod.website-files.com/6583a3bd0693f08aab1194fe/69444843af33507eea1da352_fireplace-cleaning-hepa-vacuum-soot-removal.webp" alt="Fireplace Cleaning" /></div><div className="sv1-card-body"><div className="sv1-card-header"><div className="sv1-card-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3l1.9 5.1L19 10l-5.1 1.9L12 17l-1.9-5.1L5 10l5.1-1.9z" /><path d="M19 15l.6 1.6L21 17l-1.4.4L19 19l-.6-1.6L17 17l1.4-.4z" /></svg></div><h3 className="sv1-card-title">Fireplace Cleaning</h3></div><p className="sv1-card-desc">We clean your fireplace by removing heavy build-up.</p><span className="sv1-card-link">Learn More <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M5 12h14M13 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg></span></div></a>
            <a href={`/fireplace-repair/${city.slug}`} className="sv1-card"><div className="sv1-card-img-wrap"><img className="sv1-card-img" src="https://cdn.prod.website-files.com/6583a3bd0693f08aab1194fe/694441daa14d749f6241b0a1_fireplace-repair-firebox-masonry-damage.webp" alt="Fireplace Repair" /></div><div className="sv1-card-body"><div className="sv1-card-header"><div className="sv1-card-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 9l7 7-2 2-7-7" /><path d="M9 14l-6 6 2 2 6-6" /><path d="M14 9l-5-5-3 3 5 5" /></svg></div><h3 className="sv1-card-title">Fireplace Repair</h3></div><p className="sv1-card-desc">We fix cracks and damage so your fireplace works safely again.</p><span className="sv1-card-link">Learn More <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M5 12h14M13 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg></span></div></a>
            <a href={`/fireplace-maintenance/${city.slug}`} className="sv1-card"><div className="sv1-card-img-wrap"><img className="sv1-card-img" src="https://cdn.prod.website-files.com/6583a3bd0693f08aab1194fe/694441da14746f8ed1a7a600_fireplace-maintenance-safe-home-use.webp" alt="Fireplace Maintenance" /></div><div className="sv1-card-body"><div className="sv1-card-header"><div className="sv1-card-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3" /><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 1 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.6 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 1 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.6a1.65 1.65 0 0 0 1-1.51V3a2 2 0 1 1 4 0v.09A1.65 1.65 0 0 0 15 4.6a1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 1 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z" /></svg></div><h3 className="sv1-card-title">Fireplace Maintenance</h3></div><p className="sv1-card-desc">Ongoing service that helps prevent costly repairs.</p><span className="sv1-card-link">Learn More <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M5 12h14M13 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg></span></div></a>
            <a href={`/gas-fireplace-repair/${city.slug}`} className="sv1-card"><div className="sv1-card-img-wrap"><img className="sv1-card-img" src="https://cdn.prod.website-files.com/6583a3bd0693f08aab1194fe/694441da03f91ef31c0da8f9_gas-fireplace-repair-burner-flame-performance.webp" alt="Gas Fireplace Repair" /></div><div className="sv1-card-body"><div className="sv1-card-header"><div className="sv1-card-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.72-3.45-.87-6.65 2-9 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z" /></svg></div><h3 className="sv1-card-title">Gas Fireplace Repair</h3></div><p className="sv1-card-desc">We diagnose and fix gas fireplace issues for safe, reliable heat.</p><span className="sv1-card-link">Learn More <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M5 12h14M13 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg></span></div></a>
          </div>
