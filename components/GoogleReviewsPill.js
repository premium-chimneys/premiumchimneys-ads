...
//
// The hero used to render the Elfsight widget raw, which meant 526 KB of
// third-party JS had to load before the hero looked finished — so it could
// never be deferred. Drawing the pill ourselves and layering the real widget
// on top, fully transparent, means the hero paints instantly and Elfsight is
// only fetched if someone actually reaches for it. The user's real click lands
...
/* Custom face — purely visual: clicks pass through it to the real widget
   layered above. */
.grp-face {
  position: relative;
  z-index: 1;
