  ...
  return (
    <>
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        /* The primary label is longer than the button's old fixed 210px, which
           wrapped it onto two lines beside a single-line phone button. Let it
           size to its text and keep 210px as the floor so a shorter label still
           matches its neighbour. The <=480px rule below overrides both to
           full width, so this only affects the wider breakpoints. */
        .hero-cta-primary {
          width: auto;
          min-width: 210px;
          white-space: nowrap;
      ...
      <section className="hero">
        ...
        <div className="hero-inner">
          <div className="hero-left">
            ...
            <h1 className="hero-h1">{`${cityPossessive} Trusted Local ${headingService}`}</h1>
